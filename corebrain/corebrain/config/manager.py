...
class ConfigManager:
    ...
    def _ensure_config_dir(self) -> None:
        ...
        try:
            ...
            logger.debug(f"Configuration directory secured: {self.CONFIG_DIR}")
            _print_colored(f"Configuration directory secured: {self.CONFIG_DIR}", "blue")
        ...
        try:
            if not self.SECRET_KEY_FILE.exists():
                ...
                with open(self.SECRET_KEY_FILE, 'wb') as key_file:
                    key_file.write(key)
                _print_colored(f"New secret key generated at: {self.SECRET_KEY_FILE}", "green")
            ...
            # Fallback to temporary key (less secure but functional)
    ...
    def _load_configs(self) -> Dict[str, Dict[str, Any]]:
        ...
        try:
            ...
            if not encrypted_data:
                _print_colored("Empty configuration file", "yellow")
                return {}
    ...
    def _save_configs(self) -> None:
        ...
        try:
            ...
            _print_colored(f"Configurations saved to: {self.CONFIG_FILE}", "green")
        except Exception as e:
    ...
    def remove_config(self, api_key_selected: str, config_id: str) -> bool:
        ...
        if api_key_selected in self.configs and config_id in self.configs[api_key_selected]:
            ...
            # If no configurations remain for this token, remove the entry
