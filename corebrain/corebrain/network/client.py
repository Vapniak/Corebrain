...
class APIClient:
    ...
    def get_full_url(self, endpoint: str) -> str:
        ...
        Returns:
            Full URL
        """
        # Remove '/' if it exists to avoid duplicate paths
    ...
    def handle_response(self, response: Response) -> Response:
        ...
        if 400 <= status_code < 500:
            ...
            # Specific errors according to status code
            if status_code == 401:
    ...
    def request(self, method: str, endpoint: str, *, 
        ...
        while retries <= (self.MAX_RETRIES if retry else 0):
            try:
                ...
                # Make the request
                logger.debug(f"Sending request {method} to {url}")
                ...
                # Decide if we should retry depending on the type of error
                ...
                if isinstance(e, (ReadTimeout, WriteTimeout, PoolTimeout)):
                    ...
                    raise APITimeoutError(f"The request to {endpoint} exceeded the maximum time of {request_timeout}s", 
